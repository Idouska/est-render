...
export const STRINGS = {
  fr: {
    ...
    'ag.exchanges': 'Échanges à envoyer',
    'ag.exchangesHint': 'Pas de commande à expédier : le marchand prévient lui-même son client avec votre numéro.',
    'ag.exchangeFor': 'Échange — commande {commande}',
    'ag.wanted': 'Paire à envoyer',
    'ag.fromStock': 'À prendre dans votre stock',
    'ag.exchangeSave': 'Enregistrer le numéro',
    'ag.exchangeOk': 'Numéro enregistré : le marchand prévient le client.',
    'ag.exchangeSent': 'Envoyé le {date}',
    'ag.err.echange_introuvable': 'Cet échange n’est pas confié à votre agence.',
  ...
  en: {
    ...
    'ag.exchanges': 'Exchanges to send',
    'ag.exchangesHint': 'No order to fulfil: the merchant tells the customer himself, using your number.',
    'ag.exchangeFor': 'Exchange — order {commande}',
    'ag.wanted': 'Pair to send',
    'ag.fromStock': 'Take it from your stock',
    'ag.exchangeSave': 'Save the number',
    'ag.exchangeOk': 'Number saved: the merchant will tell the customer.',
    'ag.exchangeSent': 'Sent on {date}',
    'ag.err.echange_introuvable': 'This exchange is not assigned to your agency.',
  ...
  es: {
    ...
    'ag.exchanges': 'Cambios por enviar',
    'ag.exchangesHint': 'No hay pedido que expedir: el comerciante avisa él mismo al cliente con su número.',
    'ag.exchangeFor': 'Cambio — pedido {commande}',
    'ag.wanted': 'Par por enviar',
    'ag.fromStock': 'Cójalo de su stock',
    'ag.exchangeSave': 'Guardar el número',
    'ag.exchangeOk': 'Número guardado: el comerciante avisará al cliente.',
    'ag.exchangeSent': 'Enviado el {date}',
    'ag.err.echange_introuvable': 'Este cambio no está asignado a su agencia.',
  ...
  it: {
    ...
    'ag.exchanges': 'Cambi da spedire',
    'ag.exchangesHint': 'Nessun ordine da spedire: il commerciante avvisa lui stesso il cliente con il suo numero.',
    'ag.exchangeFor': 'Cambio — ordine {commande}',
    'ag.wanted': 'Paio da inviare',
    'ag.fromStock': 'Da prendere dal suo stock',
    'ag.exchangeSave': 'Salva il numero',
    'ag.exchangeOk': 'Numero salvato: il commerciante avviserà il cliente.',
    'ag.exchangeSent': 'Inviato il {date}',
    'ag.err.echange_introuvable': 'Questo cambio non è affidato alla sua agenzia.',
