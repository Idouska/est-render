...
export const STRINGS = {
  fr: {
    ...
    'mode.bulk': 'En masse',
    'mode.bulkHint': 'Coller les numéros depuis Excel',
    'bulk.step1': 'Téléchargez la liste des commandes',
    'bulk.download': 'Télécharger .xlsx',
    'bulk.step2': 'Ajoutez le numéro de suivi en face de chaque commande',
    'bulk.step3': 'Copiez les trois colonnes — commande, suivi, transporteur — et collez-les ci-dessous',
    'bulk.pasteLabel': 'Numéros de suivi à importer',
    'bulk.placeholder': '#13811    1Z999AA10123456784    UPS\n#13812    LX123456789CN    China Post',
    'bulk.file': 'Choisir un fichier CSV',
    'bulk.check': 'Vérifier',
  ...
  en: {
    ...
    'mode.bulk': 'In bulk',
    'mode.bulkHint': 'Paste tracking numbers from Excel',
    'bulk.step1': 'Download the order list',
    'bulk.download': 'Download .xlsx',
    'bulk.step2': 'Add the tracking number next to each order',
    'bulk.step3': 'Copy the three columns — order, tracking, carrier — and paste them below',
    'bulk.pasteLabel': 'Tracking numbers to import',
    'bulk.placeholder': '#13811    1Z999AA10123456784    UPS\n#13812    LX123456789CN    China Post',
    'bulk.file': 'Choose a CSV file',
    'bulk.check': 'Check',
  ...
  zh: {
    ...
    'mode.bulk': '批量处理',
    'mode.bulkHint': '从 Excel 粘贴运单号',
    'bulk.step1': '下载订单列表',
    'bulk.download': '下载 .xlsx',
    'bulk.step2': '在每个订单旁填写运单号',
    'bulk.step3': '复制三列——订单、运单号、承运商——并粘贴到下方',
